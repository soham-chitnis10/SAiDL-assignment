...
4. The reward function is given by <img src = "images/reward_func_4.jpg">
...
All four functions are also implemented in colab so colab notebooks can be found in the same [folder](https://github.com/soham-chitnis10/SAiDL-assignment/tree/main/RL)
